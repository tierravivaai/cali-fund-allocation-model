...
## Worked example of Inverted UN Scale of Assessment: step-by-step calculation
...
* **Country B:**
  ≈ USD **0.86 million** IPLC envelope
  ≈ USD **0.86 million** State envelope

* **Country C:**
  ≈ USD **0.125 million** IPLC envelope
  ≈ USD **0.125 million** State envelope
...
* This example shows **why balance points for middle-income countries may need to be discussed** to find the right balance.
