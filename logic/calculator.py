...
def calculate_allocations(df, fund_size, iplc_share_pct, show_raw_inversion=False, exclude_high_income=False):
    ...
    if total_inv_weight > 0:
        # Normalize: inverse weight / sum(inverse weights) over eligible parties
