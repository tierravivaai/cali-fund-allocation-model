...
`spearman_vs_pure_iusaf` ranges from `0.4726` to `0.9771`. This captures overlay departure strength, not local instability.
...
Largest deviation in this sweep appears at `tsac_beta_sweep_0.15` (`spearman_vs_pure_iusaf=0.4726`).
...
- departure-from-pure-IUSAF threshold: first triggered at `tsac_beta_sweep_0.0`. Trigger: `top20_turnover_vs_pure_iusaf=0.8000` (threshold: > 0.20).
